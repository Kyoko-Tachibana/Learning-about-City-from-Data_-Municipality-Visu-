...
def vote_rate_council_mayor_general(df, n):
    ...
    fig.update_layout(
    dragmode="select", hovermode='closest', clickmode='select', template='plotly_white', width=1000, height=500)
...
layout = html.Div([html.Br(),
    ...
    value=2023, id='input-year-network', clearable=False, className='dropdown'))
             ])
       ])
      ]), className='set-value-card', color='info'
    )),
    ...
    html.Div(dbc.Accordion([dbc.AccordionItem([html.P([html.B('File Format', style={'color':'navy'}), 
                           ...
                           dbc.AccordionItem([html.P([html.B('Term of Use (利用について)', style={'color':'navy'}), 
                            ...
                            dbc.AccordionItem([html.P([html.B('Integration into your Web site', style={'color':'navy'}),
                                                      dcc.Markdown('''
                                                      A simple example generated by ChatGPT 3.5
                                                      ```
                                                      <!DOCTYPE html>
                                                      <html lang="en">
                                                      <head>
