...
layout = dbc.Container([html.Br(),
        ...
        dbc.CardBody([dbc.Col([
                  ...
                  children=[
                            ...
                            dcc.Dropdown([2022, 2018, 2014, 2010, 2006, 2002], 2022, id='input-year', 
                                                  clearable=False, style={'width':'15vw', 'color':'white', 'font-size':'12vw'})]), 
    ...
    2022, id='input-year-network', clearable=False, style={'color':'midnightblue', 'width':'15vw', 'font-size':'12vw'})
             ])
       ])
      ]), color='info', style={'width': '100%', 'margin': 'auto'}
    )),
